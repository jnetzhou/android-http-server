...
public class HttpProxyZipHandler implements HttpRequestHandler {

	private final static String TAG = "HttpProxyZipHandler";
	...
	public HttpProxyZipHandler(final String webRoot) {
		mWebRoot = webRoot;
	}
	...
	public void handle(HttpRequest request, HttpResponse response,
		...
		target = target.substring(0,
				target.length() - HttpProxyConfigs.SUFFIX_ZIP.length());
